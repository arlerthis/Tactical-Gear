        ...
        <div class="container py-md-5">
            <div class="row grids-wthree-info">
                <div class="col-lg-6 bag-img">
                    <img src="images/kit.jpg" class="img-fluid" alt="" />
                </div>
                <div class="col-lg-6 ab-info-con ab-inf-page text-left">
                    <h4>About Our Brand</h4>
                    <p>Awal mula Tactical Shop dimulai dari 2 anak sekolah yang berusaha mengembangkan usaha toko tactical milik ayahnya yang berada di sebuah rumah kecil di daerah Probolinggo, Jawa Timur . Pada awalnya, 2 anak perempuan yang masih berpendidikan di SMK 2 Kraksaan dengan jurusan Rekayasa Perangkat Lunak (RPL) ini mulai memproduksi tas dengan nama Big Bag. Nama ini diambil dari ide 2 anak perempuan itu.</p>
                    <a href="shop.php" class="btn shop mt-4">Read More</a>
                </div>
            </div>
            <div class="row grids-wthree-info text-center">
                <div class="col-lg-4 ab-content">
                    <div class="ab-info-con">
                        <h4>Pakaian</h4>
                        <p>Tactical Equipment Shop menyediakan Baju atau Celana yang berkualitas menggunakan bahan Ripstok.</p>
                    </div>
                </div>
                <div class="col-lg-4 ab-content">
                    <div class="ab-info-con">
                        <h4>Alat Camping</h4>
                        <p>Tactical Equipment Shop menyediakan kebutuhan alat Camping seperti tenda, matras, flysheet, dll.</p>
                    </div>
                </div>
                <div class="col-lg-4 ab-content">
                    <div class="ab-info-con">
                        <h4>Survival Kit</h4>
                        <p>Tactical Equipment Shop menyediakan alat kit survival seperti pisau lipat, kompor portable, gas portable, senter, dll.</p>
                    </div>
                </div>
    ...
    <section class="collections">
        <div class="container-fluid">
            <div class="row">
                ...
                <img src="images/orghiking.webp" class="img-fluid" alt="" />

                </div>
                <div class="col-md-4 ab-content text-center p-lg-5 p-3 my-lg-5">
                    <h4>Travel Jadi Keren</h4>
                    <p>Buat dirimu menjadi lebih keren dengan produk Tactical Gear milik kami.</p>
